...
class HrPayslip(models.Model):
    ...
    def action_payslip_done(self):
        ...
        #         ##
        #         ##omara added
        #         empployee_analytic_account_id = None
        #         if slip.employee_id.contract_id and slip.employee_id.contract_id.analytic_account_id:
        #             empployee_analytic_account_id = slip.employee_id.contract_id.analytic_account_id.id
        #             for rec_in_dict in line_ids:
        #                 rec_in_dict['analytic_account_id'] = empployee_analytic_account_id
        #         ##
        #         ##
