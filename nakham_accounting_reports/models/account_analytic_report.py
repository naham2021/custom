...
class analytic_report(models.AbstractModel):
    ...
    def _get_lines(self, options, line_id=None):
        ...
        if options['analytic_groups']:
            analytic_group_ids = [int(id) for id in options['analytic_groups']]
            analytic_entries_domain += [('analytic_group_ids', 'in', analytic_group_ids)]
            # AccountAnalyticAccount = AccountAnalyticAccount.with_context(analytic_group_ids=analytic_group_ids)
            analytic_account_domain += [('group_id', 'in', analytic_group_ids)]
