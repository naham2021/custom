odoo.define('nakham_accounting_reports.account_report', function (require) {
'use strict';
...
//            self.$searchview_buttons.find('[data-filter="analytic_groups"]').select2("val", self.report_options.analytic_groups);
//            console.log('zzzzzzzzzaz')
//            console.log(self.report_options.analytic_accounts)
//        }
...
//            self.report_options.analytic_groups = self.$searchview_buttons.find('[data-filter="analytic_groups"]').val();
//            console.log('zzzzzzzzzazaaaaaaaaaa')
//            return self.reload().then(function(){
...
var accountReportsWidget = AbstractAction.extend(ControlPanelMixin, {
    ...
    render_searchview_buttons: function() {
        ...
        if (self.report_options.analytic) {
            ...
            self.$searchview_buttons.find('[data-filter="analytic_tags"]').select2("val", self.report_options.analytic_tags);
            self.$searchview_buttons.find('[data-filter="analytic_groups"]').select2("val", self.report_options.analytic_groups);
//            self.$searchview_buttons.find('[data-filter="account_groups"]').select2("val", self.report_options.account_groups);
...
//            console.log('zzzzzzzzzazaaaaaaaaaa')
        ...
        this.$searchview_buttons.find('.js_account_reports_analytic_auto_complete').on('change', function(){
            ...
            self.report_options.analytic_tags = self.$searchview_buttons.find('[data-filter="analytic_tags"]').val();
            self.report_options.analytic_groups = self.$searchview_buttons.find('[data-filter="analytic_groups"]').val();
//            self.report_options.account_groups = self.$searchview_buttons.find('[data-filter="account_groups"]').val();

//            console.log('mmmmmmmmmmmmmmzaaaaaaaaaa')
            return self.reload().then(function(){
                self.$searchview_buttons.find('.account_analytic_filter').click();
            })
        });
